...
class TestDivergenceNonUniform(unittest.TestCase):
    """
    Test divergence operator on multiple nonuniform elements
    """
    def test_Divergence1(self):
        nelx = 3
        nely = 1
...
class TestDivergenceStretched(unittest.TestCase):
    """
    Test divergence operator on multiple stretched elements
    """
    def test_Divergence1(self):
        nelx = 3
        nely = 1
